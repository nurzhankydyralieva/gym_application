...
public class TraineeDAOImplTest {
    ...
    public void testShouldUpdateTraineesTrainerList() {
        ...
        TraineesTrainerListUpdateResponseDTO responseDTO = service.updateTraineesTrainerList(id, requestDTO);

        verify(traineesTrainerListUpdateMapper, times(1)).toEntity(requestDTO);
        verify(session, times(1)).get(Trainee.class, id);
        verify(session, times(1)).update(any(Trainee.class));
        verify(traineesTrainerListUpdateMapper, times(1)).toDto(trainee);
    }
}
